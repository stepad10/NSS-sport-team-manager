...
import eu.profinit.stm.configuration.AppProperties;
import eu.profinit.stm.exception.BadRequestException;
import eu.profinit.stm.security.jwt.TokenProvider;
import eu.profinit.stm.util.CookieUtils;
...
import static eu.profinit.stm.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
